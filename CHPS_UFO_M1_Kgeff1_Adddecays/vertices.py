...
V_8 = Vertex(name = 'V_8',
             particles = [ P.s__tilde__, P.c, P.eta, P.G__minus__ ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFSS5, L.FFSS7 ],
             couplings = {(0,0):C.GC_77,(0,1):C.GC_109})

V_9 = Vertex(name = 'V_9',
             particles = [ P.b__tilde__, P.t, P.eta, P.G__minus__ ],
             color = [ 'Identity(1,2)' ],
             lorentz = [ L.FFSS5, L.FFSS7 ],
             couplings = {(0,0):C.GC_117,(0,1):C.GC_69})

V_10 = Vertex(name = 'V_10',
              particles = [ P.d__tilde__, P.u, P.eta, P.G__minus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS5, L.FFSS7 ],
              couplings = {(0,0):C.GC_133,(0,1):C.GC_85})

V_11 = Vertex(name = 'V_11',
              particles = [ P.c__tilde__, P.c, P.eta, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS8 ],
...
V_14 = Vertex(name = 'V_14',
              particles = [ P.t__tilde__, P.t, P.eta, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS8 ],
...
V_17 = Vertex(name = 'V_17',
              particles = [ P.u__tilde__, P.u, P.eta, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS8 ],
...
V_20 = Vertex(name = 'V_20',
              particles = [ P.u__tilde__, P.d, P.eta, P.G__plus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS5, L.FFSS7 ],
              couplings = {(0,0):C.GC_85,(0,1):C.GC_133})

V_21 = Vertex(name = 'V_21',
              particles = [ P.d__tilde__, P.d, P.eta, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS8 ],
...
V_24 = Vertex(name = 'V_24',
              particles = [ P.c__tilde__, P.s, P.eta, P.G__plus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS5, L.FFSS7 ],
              couplings = {(0,0):C.GC_109,(0,1):C.GC_77})

V_25 = Vertex(name = 'V_25',
              particles = [ P.s__tilde__, P.s, P.eta, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS8 ],
...
V_28 = Vertex(name = 'V_28',
              particles = [ P.t__tilde__, P.b, P.eta, P.G__plus__ ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS5, L.FFSS7 ],
              couplings = {(0,0):C.GC_69,(0,1):C.GC_117})

V_29 = Vertex(name = 'V_29',
              particles = [ P.b__tilde__, P.b, P.eta, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFSS8 ],
...
V_32 = Vertex(name = 'V_32',
              particles = [ P.ve__tilde__, P.e__minus__, P.eta, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFSS5 ],
              couplings = {(0,0):C.GC_93})

V_33 = Vertex(name = 'V_33',
              particles = [ P.e__plus__, P.e__minus__, P.eta, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.FFSS8 ],
...
V_36 = Vertex(name = 'V_36',
              particles = [ P.vm__tilde__, P.mu__minus__, P.eta, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFSS5 ],
              couplings = {(0,0):C.GC_101})

V_37 = Vertex(name = 'V_37',
              particles = [ P.mu__plus__, P.mu__minus__, P.eta, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.FFSS8 ],
...
V_40 = Vertex(name = 'V_40',
              particles = [ P.vt__tilde__, P.ta__minus__, P.eta, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFSS5 ],
              couplings = {(0,0):C.GC_125})

V_41 = Vertex(name = 'V_41',
              particles = [ P.ta__plus__, P.ta__minus__, P.eta, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.FFSS8 ],
...
V_46 = Vertex(name = 'V_46',
              particles = [ P.e__plus__, P.ve, P.eta, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFSS7 ],
              couplings = {(0,0):C.GC_93})

V_47 = Vertex(name = 'V_47',
              particles = [ P.mu__plus__, P.vm, P.eta, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFSS7 ],
              couplings = {(0,0):C.GC_101})

V_48 = Vertex(name = 'V_48',
              particles = [ P.ta__plus__, P.vt, P.eta, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFSS7 ],
              couplings = {(0,0):C.GC_125})
...
V_177 = Vertex(name = 'V_177',
               ...
               couplings = {(0,1):C.GC_30,(0,0):C.GC_37})
