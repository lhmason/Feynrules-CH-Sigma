...
GC_16 = Coupling(name = 'GC_16',
                 value = '-(Fgg*complex(0,1)*G**2)/(32.*fa*cmath.pi**2) - (complex(0,1)*G**2*Kg)/(32.*fa*cmath.pi**2)',
                 order = {'NP':1,'QCD':2})

GC_17 = Coupling(name = 'GC_17',
                 value = '-(Fgg*G**3)/(16.*fa*cmath.pi**2) - (G**3*Kg)/(16.*fa*cmath.pi**2)',
                 order = {'NP':1,'QCD':3})

GC_18 = Coupling(name = 'GC_18',
                 value = '-(ee**2*Faa*complex(0,1)*Kaa)/(8.*fa*cmath.pi**2) - (ee**2*complex(0,1)*Kaa**2)/(8.*fa*cmath.pi**2) - (ee**2*complex(0,1)*Kw)/(8.*fa*cmath.pi**2)',
                 order = {'NP':1,'QED':2})
