...
FF1 = Lorentz(name = 'FF1',
               spins = [ 3, 3, 1 ],
               structure = '-Fgg*4*Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,1) + Fgg*4*Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,2)',
               formfactors = [ForFac.Fgg])
...
FF2 = Lorentz(name = 'FF2',
               spins = [ 3, 3, 1 ],
               structure = '- Faa *(Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,1)) + Faa * Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,2)',
               formfactors = [ForFac.Faa])
